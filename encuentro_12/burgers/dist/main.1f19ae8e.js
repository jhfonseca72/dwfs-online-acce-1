...
var data = [{
  name: "Restaurant 1",
  image_api: "https://foodish-api.herokuapp.com/api/",
  location: {
    lat: -75.567213,
    lng: 6.240727
  }
...
var API_BURGER_URL = "https://601c74da1a9c220017060a09.mockapi.io/api/v1/restaurants"; //using animation.css
...
var createImage = function createImage(productImage, productName) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _axios.default.get(API_BURGER_URL);
...
var fetchImage = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(image_api) {
    var response;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _axios.default.get(image_api);

          case 2:
            response = _context2.sent;
            return _context2.abrupt("return", response.data.image);
...
var addMarkers = function addMarkers(restaurants, map) {
...
var addFiguresByRestaurants = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(data) {
    var _iterator2, _step2, element, image, imageElement;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            _context3.next = 7;
            return fetchImage(element.image_api);

          case 7:
            image = _context3.sent;
            imageElement = createImage(image, element.name);
  ...
  return function addFiguresByRestaurants(_x2) {
...
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./data.js":"data.js","axios":"node_modules/axios/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
